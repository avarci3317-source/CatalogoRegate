...
/* Mobile - single column, much larger and bolder */
@media (max-width:768px){
  ...
  /* Iconos y carrito centrados y grandes */
  ...
  /* Catálogo: UNA COLUMNA (apilar verticalmente) */
  .catalogo{
    margin-top:160px;
    gap:20px;
  ...
  .producto{
    width:94%;                  /* tarjeta amplia en móvil */
    padding:20px;
    margin:8px 0;
    border-radius:16px;
  }

...
/* Carrito panel */
#carrito{
  position:fixed;top:86px;right:20px;background:var(--card);border:2px solid var(--accent);
...
/* Catalogo */
.catalogo{margin-top:130px;width:95%;margin-left:auto;margin-right:auto;display:flex;flex-wrap:wrap;justify-content:space-around;gap:16px;padding-bottom:80px}
.producto{
  width:30%;background:var(--card);margin:10px;padding:16px;border-radius:14px;box-shadow:0 8px 24px rgba(0,0,0,0.6);
...
@media (min-width:1200px){
  ...
  .redes a{width:40px;height:40px;font-size:20px}
}
...
/* Mobile - make everything much larger and bolder */
@media (max-width:768px){
  /* Header stacked and huge title */
  ...
  /* Redes and icons centered and very large */
  ...
  /* Carrito toggle larger and pill-like */
  #toggleCarrito{
    padding:14px 18px;font-size:22px;border-radius:30px;
    box-shadow:0 12px 30px rgba(0,0,0,0.6)
  }
  #toggleCarrito .badge{
    min-width:34px;padding:8px 12px;font-size:16px;border-radius:18px;font-weight:900
  }

  /* Carrito panel wider and lower */
  #carrito{
    width:96%;right:2%;top:140px;max-height:64vh;padding:18px;border-radius:14px;
  }
  #carrito h3{font-size:22px}
  #carrito li{font-size:17px;padding:10px 0}

  /* Catalog layout: single column, big cards */
  .catalogo{margin-top:180px;gap:20px;padding-bottom:120px}
  .producto{width:100%;padding:20px;border-radius:16px}
  .producto h2{font-size:26px}
  .producto .precio{font-size:22px}
  .producto .tallas{font-size:18px}

  /* Carrusel very tall for mobile */
  .swiper{height:420px}
  .swiper-pagination{bottom:16px!important}

  /* CTA button larger */
  .boton{padding:16px 22px;font-size:20px;border-radius:12px}

  /* Ensure icons and title feel prominent */
  .header-inner{max-width:980px}
}

/* Very small devices (extra emphasis) */
@media (max-width:420px){
  ...
  .boton{font-size:22px;padding:18px 24px}
}
</style>
</head>
<body>
